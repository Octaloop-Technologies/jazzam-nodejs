...
const CRM_CONFIGS = {
  ...
  hubspot: {
    ...
    scope: "crm.objects.companies.read crm.objects.companies.write crm.objects.contacts.read crm.objects.contacts.write crm.objects.products.read crm.schemas.contacts.read oauth",
    responseType: "code",
  },
  dynamics: {
